...
var getNextPage = function getNextPage(_ref3) {
	...
	return _axios2.default.get(url).then(function (res) {
		if (res.data && res.data.length > 0) {
			...
			return getNextPage({ tableau: tableau, offset: offset, baseUrl: baseUrl, path: path, token: token, limit: limit, boardIds: boardIds, table: table, doneCallback: doneCallback });
		} else if (offset === 0) {
...
module.exports = {
	urlToAccountName: urlToAccountName,
	getToken: getToken,
	getBoards: getBoards,
...
var buildURL = __webpack_require__(350);
var parseHeaders = __webpack_require__(351);
var isURLSameOrigin = __webpack_require__(352);
...
var defaults = __webpack_require__(90);
var utils = __webpack_require__(18);
var InterceptorManager = __webpack_require__(355);
...
var utils = __webpack_require__(18);
var transformData = __webpack_require__(357);
...
var _common = __webpack_require__(129);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var apiError = function apiError(err) {
	(0, _jquery2.default)("#errorMsg").html("Sorry, there was an error with your login credentials or token. Please verify and try again.").show();
	(0, _jquery2.default)("#auth").show();
	(0, _jquery2.default)("#boards").hide();
	(0, _jquery2.default)("#getBoards").removeClass("is-loading");
...
var displayBoards = function displayBoards(boards) {
	...
	(0, _jquery2.default)("#boardList").empty().append(html.join(""));
	(0, _jquery2.default)("#auth").hide();
...
var registerEventHandlers = function registerEventHandlers() {
	(0, _jquery2.default)("#loginTab").click(function () {
		(0, _jquery2.default)("#tokenTab").removeClass("is-active");
		(0, _jquery2.default)("#loginTab").addClass("is-active");
		(0, _jquery2.default)("#loginPanel").show();
		(0, _jquery2.default)("#tokenPanel").hide();
	});

	(0, _jquery2.default)("#tokenTab").click(function () {
		(0, _jquery2.default)("#loginTab").removeClass("is-active");
		(0, _jquery2.default)("#tokenTab").addClass("is-active");
		(0, _jquery2.default)("#loginPanel").hide();
		(0, _jquery2.default)("#tokenPanel").show();
	});

	(0, _jquery2.default)("#backButton").click(function () {
	...
	(0, _jquery2.default)("#getBoards").click(function () {
		(0, _jquery2.default)("#errorMsg").hide();
		(0, _jquery2.default)("#getBoards").addClass("is-loading");
		var baseUrl = (0, _common.normalizeBaseUrl)((0, _jquery2.default)("#account").val().trim());
		(0, _jquery2.default)("#account").val(baseUrl);
		var account = (0, _common.urlToAccountName)(baseUrl);
		// todo: validate baseUrl and account
		if ((0, _jquery2.default)("#loginTab").hasClass("is-active")) {
			var username = (0, _jquery2.default)("#username").val().trim();
			var password = (0, _jquery2.default)("#password").val().trim();
			// todo: validate username/password
			(0, _common.getToken)({ baseUrl: baseUrl, account: account, username: username, password: password }).then(function (token) {
				(0, _jquery2.default)("#token").val(token);
				return (0, _common.getBoards)({ baseUrl: baseUrl, token: token });
	...
	(0, _jquery2.default)("#submitButton").click(function () {
		...
		var token = (0, _jquery2.default)("#token").val();
		var boardIds = (0, _jquery2.default)("#boardList").val();
...
var _common2 = __webpack_require__(362);
...
(function () {
	var createConnector = function createConnector() {
		...
		connector.getData = function (table, doneCallback) {
			...
			(0, _common.getNextPage)({ tableau: tableau, offset: 0, baseUrl: baseUrl, path: path, token: token, limit: limit, boardIds: boardIds, table: table, doneCallback: doneCallback });
		};
